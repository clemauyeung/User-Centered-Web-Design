...
| Survey | Good for getting answers to specific questions (known issues) from a large group of people. Good for collecting data on preferences, attitudes, and motivations from a wide range of participants. Data is generalizable. | Bad survey design (ambiguous/confusing questions, ordering questions, biased questions) leads to bad data. Completion of survey depends on participants' motivation, so incompleteness is a risk. Some respondents are self-selecting so data may be skewed. |
